...
class deck:
    ...
    # This class Initializes the deck, and adds jokers if specified
    ...
    # This function Cuts the deck by the amount specified
    # This function Returns true if the deck was cut successfully and false otherwise
    def cut(self, amount):
    ...
    # This Function Returns a data dictionary
